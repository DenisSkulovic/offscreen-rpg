...
Ordinary life is not limited to following a prepared itinerary. The Storyteller can establish reusable local opportunities, then remain dormant while the player freely chooses among their currently eligible forms. Fishing, rest or routine social time can repeat without regenerating their rules or menu. The Storyteller curates contextual availability; the game enforces captured conditions, so dramatic situations need not expose inappropriate sleep or departure options. The [prepared-local-life contract](gameplay.md#prepared-local-life-while-the-storyteller-is-dormant) distinguishes this from both universal activity buttons and fresh generation after every choice.
