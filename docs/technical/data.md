...
The browser receives a story ID, narrative revision, current passage content and offered interaction. It receives no source code, effect instructions or owner information. Migration `0004_story_initialization` introduces these tables. Appending consequences and listing retained stories remain subsequent operations; a first saved passage does not prove those flows.
