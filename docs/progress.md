...
**Current focus:** complete the experience gate for [Storyteller agency and taste](features/2026-09-19--00-26--storyteller-agency-and-taste/FEATURE.md). The offline mechanical source replaces generic assess loops with authored state-responsive pineapple and microbe plans, unknown seeds hold honestly, and opening/live-play options now show attempted commitment plus optional apparent risk without private mechanics. The next evidence is a persisted browser walkthrough and owner taste review. The later [earned-time loop](features/2026-09-19--00-26--earned-time-playable-loop/FEATURE.md), [bounded autonomy](features/2026-09-19--00-26--bounded-autonomy-and-reentry/FEATURE.md), [inhabitable return](features/2026-09-19--00-26--inhabitable-play-and-return/FEATURE.md), and [premise-driven setup](features/2026-09-19--00-26--premise-to-playable-campaign/FEATURE.md) remain approved roadmap work, not implemented behavior.
...
For the current agency/taste work, 27 Storyteller tests and 16 game tests pass. Storyteller, game, contracts and application builds pass; web typecheck and the API integration TypeScript build pass. The updated three-round integration asserts that taking cover produces a different investigative offer, but the PostgreSQL/Temporal/browser scenario has not run. No complete generated mechanical browser playthrough or agent-tool rehearsal has been demonstrated.
