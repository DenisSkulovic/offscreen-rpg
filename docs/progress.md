...
Evaluation is now designed as a parallel enabling sequence: [QA journeys](features/2026-09-18--17-27--qa-journeys-and-evidence/FEATURE.md) define the player-flow checks and evidence, the [trace explorer](features/2026-09-18--17-27--storyteller-trace-explorer/FEATURE.md) makes operations inspectable, and [conservative live evaluation](features/2026-09-18--17-27--conservative-live-model-evaluation/FEATURE.md) permits a tiny explicitly authorized OpenRouter probe only after dry-run, trace and accounting preflights pass.
