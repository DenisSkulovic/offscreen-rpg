...
**Next action:** Address typed-state outcome coherence without parsing prose or imposing a creative default. The per-domain [canon-invention policy](features/2026-09-24--01-30--canon-invention-policy/FEATURE.md) now has an owner-requested dormant dossier with executable phases; activate it after the typed-state checkpoint and before meaningful 30–50-turn private-world evaluation. It is intentionally not another profile field or temperature knob. The repaired state-indexed `storyteller.v11` contract has one valid live Sol proof: generation `76d3839b-271e-4e14-802c-9073765cc820` passed strict transport and semantic admission with five plans and the exact authorized warehouse process. Its Quiet Eerie Mystery prose and choice character are strong. Diagnosis traced the five-second directions plan and eight-second road leg to authored fixture content; they are now 60 and 900 seconds. Vvardenfell owns bounded human-scale calibration for future estimates, while generic committed-time rules remain world-neutral. The fixed evaluation harness now imports and attaches the same pinned start package as Story mode: provider-free held generation `9eeaf3fe-d19c-4b1b-a5a4-5cfb0f6d7350` includes both the Vvardenfell calibration and selected committed-time rule in a 36,666-byte request and remained at zero attempts/spend. The model's earlier thirty-minute close inspection therefore remains evidence about the old impoverished packet, not the corrected context. Departure without a typed location effect remains a separate admission-design finding. The live attempt settled and matched at 17,796 microusd, with zero persistent reservation; OpenRouter account usage still lagged at the prior USD 0.657259296, so no further provider call ran. Existing story `23ea2420-d8e5-41a5-8c83-9346184e52fe` remains the v10 repair proof at revision 2. Gameplay quality remains judged against the exact story and Storyteller configuration. UI polish is lower priority.
...
| Storyteller tasks | Opening, continuation, consequence and report-only contracts; bounded context, multi-round retrieval, execution, publication and recovery; v11 nonzero effects, state-indexed plan prerequisites and compact compiled mechanical openings | One repaired v11 opening is live-valid; reliability, sustained play and later-recall publication remain unproved |
