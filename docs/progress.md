...
**Current focus:** owner-requested experience recalibration before more implementation. Direct receipts, bounded emergent state, generated mechanical opening plans and one offline DM-turn contract provide a useful authority spine, but the current scripted loop repeats generic assess actions and does not demonstrate satisfying play. Five draft proposals now define the missing experience: [Storyteller agency and taste](features/2026-09-19--00-26--storyteller-agency-and-taste/FEATURE.md), an [earned-time playable loop](features/2026-09-19--00-26--earned-time-playable-loop/FEATURE.md), [bounded autonomy and re-entry](features/2026-09-19--00-26--bounded-autonomy-and-reentry/FEATURE.md), [inhabitable play and return](features/2026-09-19--00-26--inhabitable-play-and-return/FEATURE.md), and [premise-to-playable campaign setup](features/2026-09-19--00-26--premise-to-playable-campaign/FEATURE.md). They await owner review; no implementation is authorized by their creation.
...
The [playable DM adjudication loop plan](features/2026-09-18--17-21--playable-dm-adjudication-loop/PLAN.md) is paused at the experience-review boundary. Offer-local private plans, pure proposal diagnostics, direct resolution, scoped fact admission and bounded opening/consequence planning exist. Do not continue by merely making the generic three-round test run: first agree the agency/taste examples and earned-time gold flow listed in the [feature index](features/README.md).
...
The latest implemented checkpoints through `8ad4e30` reported 16 passing game tests, 25 passing Storyteller tests, successful Storyteller/application builds and a successful web typecheck. The API integration scenario for three generated mechanical rounds compiles but has not run because PostgreSQL and Temporal were unavailable with the local Docker engine. More importantly, that scenario checks persistence and fresh offer identity, not whether a saved fact or roll produces a meaningfully different next choice. No complete generated mechanical browser playthrough or agent-tool rehearsal has been demonstrated. This proposal pass runs no builds or runtime tests.
