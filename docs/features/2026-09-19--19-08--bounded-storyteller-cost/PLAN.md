...
- Spend: B2c implementation and fake-provider verification were provider-free. The first newly captured Sol opening then reproduced the known zero-delta invalid plan and exposed a settlement guard that incorrectly forbade a failed generation from retaining repair evidence while its operation stayed open. The provider reported USD 0.0215535; because settlement aborted, the ledger conservatively retains its USD 0.050480 reservation as uncertain liability. The guard now admits only the exact retained-invalid-output transition and focused provider recovery passes again. Total known 2026-09-23 development inference is USD 0.2897993. The old held story remains one-shot and cannot be repaired retroactively.
