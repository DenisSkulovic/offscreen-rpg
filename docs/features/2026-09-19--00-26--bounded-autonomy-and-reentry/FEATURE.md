...
Status: Approved and partially implemented. Bounded quiet settlement (U2a), source-bound historical reports (core U2b), and durable finite accepted chains with pending-entry cancellation and a tick horizon (U2c) are implemented. Deterministic manual report controls, richer chain editing and later delegated fallbacks/notifications remain unfinished.
