...
> **Delivery ownership:** this document remains the shared authority and owns the later episodic/source, semantic and relational progression. [Bounded exploration](../2026-09-21--10-55--storyteller-memory-exploration/PLAN.md) is the one active delivery slice. The oracle/evaluator foundation, indexed lexical retrieval and evidence packing are implemented permanent infrastructure documented in the long-story memory guide, Storyteller runtime and QA journeys. Conditional later stages stay here and in permanent documentation until one is authorized for implementation; do not keep dependency-placeholder folders or implement duplicate schemas and runners.
