...
- Exact next action: add explicit multi-case fixture selection and emit the machine-readable manifest/readable comparison. Add the maintained QA catalogue case with that command.
