...
No active feature is currently being implemented through this workflow. Select the next slice from [Progress](../progress.md), discuss its scope and prepare its feature proposal before bulk coding.
...
- [Playable opening candidate](00-40--18-09-2026-playable-opening-candidate/FEATURE.md) — persist and review a deterministic playable opening; Start from that candidate is the next slice.
