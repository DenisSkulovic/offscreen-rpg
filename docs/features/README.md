...
The immediate architecture slice is [event-oriented gameplay transitions E1](2026-09-20--01-40--event-oriented-gameplay-transitions/PLAN.md): extract typed state/fact/follow-up decisions from finite-action settlement without adding a generic event bus or changing gameplay. E2 then applies the demonstrated seam to activity quiet/report/scene completion before returning to broader feature work.
...
Nearest prepared work: [deliberate action time T1](2026-09-19--22-13--deliberate-action-time/PLAN.md) follows the owner's correction that every elapsed interval needs an accepted commitment, including short story actions. Read its [contract](../technical/committed-time.md), then implement explicit execution eligibility and preparation-intent holds before finite action duration and bounded overlapping narration. The remaining [bounded-cost B2](2026-09-19--19-08--bounded-storyteller-cost/PLAN.md) recovery matrix consumes that contract; B1, operation/window accounting, dispatch authority and blocker projection already exist. [Canonical storage and creative bundles](2026-09-19--18-49--canonical-campaign-storage/PLAN.md) C1/C2 remains independently ready, followed by [memory/exploration](2026-09-18--20-09--storyteller-memory-and-recall/PLAN.md). Memory Phase 3 cannot precede completed B2 enforcement; B3 integrates with memory rather than creating a second runner. The harbor/return flow remains the acceptance anchor.
