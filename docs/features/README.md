...
| 4 | [Situations S2](2026-09-19--13-49--storyteller-authored-situations/PLAN.md#s2--dormant-reuse-and-revalidation) + [Autonomy U2a](2026-09-19--00-26--bounded-autonomy-and-reentry/PLAN.md#u2a--quiet-settlement-and-factual-continuation) — in progress | Quiet B→authorized A handoff implemented; independently selected/repeated authored activities remain |
...
2. [Storyteller-authored situations and reusable choices](2026-09-19--13-49--storyteller-authored-situations/FEATURE.md) — owns per-situation choice authorship, explicit activity access, reusable definitions and dormant offer reuse. New focused feature, not a second engine/queue.
