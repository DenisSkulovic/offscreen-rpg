...
| [Provider dispatch review](2026-09-19--22-58--provider-dispatch-review/FEATURE.md) | D1 exact packet → D2 durable hold/release → D3 Chamber analysis → D4 linked evidence | Zero-cost dry-run inspection and hash-scoped release before any provider call |
