...
| 5 | [Activity A2b](2026-09-18--16-48--activity-processes-and-progress/PLAN.md#2b--durable-activity-history-and-correlated-diagnostics-next-observability-slice) | Player-safe durable lifecycle ledger plus correlated structured runtime diagnostics; no event-sourcing rewrite |
| 6 | [Autonomy U2b](2026-09-19--00-26--bounded-autonomy-and-reentry/PLAN.md#u2b--historical-reports-and-controlling-scenes) | Optional historical report versus controlling scene; late publication and failure semantics |
| 7 | [Situations S3](2026-09-19--13-49--storyteller-authored-situations/PLAN.md#s3--bounded-preparation-and-explicit-handoff) | Bounded supported task proposals and explicit return-to-work authorization, scripted source only |
| 8 | [Autonomy U2c](2026-09-19--00-26--bounded-autonomy-and-reentry/PLAN.md#u2c--finite-accepted-chains) | Finite player-accepted sequence with one successor owner; no scene-decision delegation |
