...
- Phase: K2b closeout after `f6b68d4`; K1/K2a and the controlling K2b path are implemented. The current cleanup makes benchmark setup seeds and scripted Storyteller outputs single-source and gives generic world conditions extensible typed provenance. Add the optional non-controlling obligation-report classification, then fold permanent guidance and close the feature before deliberate-time T3 overlap.
