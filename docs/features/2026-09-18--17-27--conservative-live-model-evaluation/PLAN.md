...
Define captured case/model/route/pricing/limit policy, worst-case reservation, balance/accounting snapshot and preflight failures. Add a dry-run mode that proves every check without dispatch.
