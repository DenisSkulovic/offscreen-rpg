...
Read [Progress](docs/progress.md), then only the relevant product and technical documents. The rules index is [.agents/README.md](.agents/README.md). Do not load every rule, skill and feature into context.
