...
- Storytellers may originate incidents and compatible entities without simulated faction leaders or causal prehistory. Rules own admitted consequences; generated prose cannot bypass them.
...
- Generic settings, bodies and scale concepts. D&D remains the intended foundation; source subset and explicit adaptations remain open. Fishermen, miners, spacecraft and other examples are not required mechanics.
