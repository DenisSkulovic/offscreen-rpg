...
2. Pure immediate resolution chooses an automatic or checked outcome once. The application atomically saves the `game_action_receipt`, character effects, consumed offer, command receipt and outbox follow-up. Immediate actions do not create an activity or advance the campaign clock.
