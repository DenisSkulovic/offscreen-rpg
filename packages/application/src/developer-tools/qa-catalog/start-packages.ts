  ...
  defineCase({
    ...
    stages: [
      ...
      stage({
        ...
        observableExpectation:
          'The trace exposes compact candidates, exact evidence and a replayable final candidate. A separate over-budget request becomes a durable read-limit failure without another scripted decision; no prose is published.',
        authoritativeExpectation:
          'Body reads recheck the captured manifest. The hashed request recovers without another Storyteller decision, task-local handles survive restoration, four reads stay within limits, and the reserved final round remains unavailable to context requests.',
      }),
      stage({
        id: 'retry',
