...
function greywakeCorpus(sceneCount: number): LongStoryMemoryCorpus {
  ...
  const records = evidence(id, [
    ...
    { key: 'relationship.brass-key-hiding-place', revision: 1, path: 'relationships/brass-key-hiding-place.md', kind: 'relationship', authority: 'canon', visibility: 'player-known', title: "The brass key's old hiding place", body: 'Mira Vale accepted the brass key and promised to keep it beneath the blue ledger.', sourceSequences: [7] },
